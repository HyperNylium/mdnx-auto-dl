...
from __appdata__.modules.Vars import (
    config,
    VERSION, CONFIG_DEFAULTS, MDNX_SERVICE_CR_TOKEN_PATH, MDNX_SERVICE_HIDIVE_TOKEN_PATH, PLEX_CONFIGURED, JELLY_CONFIGURED,
...
if __name__ == "__main__":
    ...
    log_manager.info(f"mdnx-auto-dl v{VERSION} has started.")
    get_running_user()
    update_mdnx_config()
