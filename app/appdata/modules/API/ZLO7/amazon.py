...
from appdata.modules.Vars import (
    config,
    VALID_LOCALES, ZLO_SERVICE_BIN_PATH, ZLO_CODE_TO_MDNX_DUB_CODE, MDNX_DUB_CODE_TO_ZLO_CODE, ZLO_SUBTITLE_LOCALE_ALIAS_TO_LOCALE,
...
class AMAZON_ZLO_API:
    def __init__(self) -> None:
        ...
        self.zlo_service = "amazon"
        self.queue_service = "zlo-amazon"
        self.service_config = config.zlo.amazon
    ...
    def _normalize_dubs(self, raw_dubs: list) -> list[str]:
        ...
        for raw_dub in raw_dubs:
            normalized_dub_code = str(raw_dub).strip()
            ...
            mapped_dub_code = ZLO_CODE_TO_MDNX_DUB_CODE.get(upper_dub_code)
            if mapped_dub_code is None and lower_dub_code in MDNX_DUB_CODE_TO_ZLO_CODE:
                mapped_dub_code = lower_dub_code
