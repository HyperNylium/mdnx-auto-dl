...
from appdata.modules.Vars import (
    config,
    VALID_LOCALES, ZLO_SERVICE_BIN_PATH, ZLO_CODE_TO_MDNX_DUB_CODE,
...
class CR_ZLO_API:
    ...
    def start_monitor(self, series_id: str) -> str:
        ...
        tmp_cmd = [self.zlo_path, "--service", self.zlo_service, "--srz", series_id]
    ...
    def _extract_json_payload(self, output: str):
        ...
        cleaned_output = self.ansi_escape_pattern.sub("", output or "")
