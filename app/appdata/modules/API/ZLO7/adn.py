...
class ADN_ZLO_API:
    def __init__(self) -> None:
        ...
        self.zlo_service = "adn"
        self.queue_service = "zlo-adn"
        self.service_config = config.zlo.adn
    ...
    def start_monitor(self, series_id: str) -> str:
        ...
        tmp_cmd = [self.zlo_path, "--service", self.zlo_service, "--srz", series_id, "--full", "--workers", "1", "--jsonOutput", self.json_path, "--configPath", self.service_config.configPath]
        ...
        for json_index, season_data in enumerate(seasons_list):
            ...
            for episode_data in raw_episode_list:
                ...
                if raw_season_number not in (None, ""):
                    ...
                    if remote_specials.is_remote_special("zlo", "adn", series_id, override_season_key, override_episode_number, episode_id=override_episode_id):
