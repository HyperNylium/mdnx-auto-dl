...
class CR_CDL_API:
    def __init__(self) -> None:
        ...
        self.cdl_service = "crunchy"
        self.queue_service = "cdl-crunchyroll"
        self.service_config = config.cardinaldl.crunchyroll
        self.worker_count = str(self.service_config.workers if self.service_config.workers is not None else 3)
    ...
    def start_monitor(self, series_id: str) -> str:
        ...
        if self.service_config.full_listing:
            tmp_cmd += ["--full", "--workers", self.worker_count]
        ...
        for json_index, season_data in enumerate(seasons_list):
            ...
            for episode_data in raw_episode_list:
                ...
                if raw_season_number not in (None, ""):
                    ...
                    if remote_specials.is_remote_special("cardinaldl", "crunchyroll", series_id, override_season_key, override_episode_number, episode_id=override_episode_id):
