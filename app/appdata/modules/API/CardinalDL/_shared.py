...
LANG_MAP: dict[str, tuple[str, str | None]] = {
    ...
    "EnglishIndia": ("EN-IN", None),
    "English (UK)": ("EN-GB", None),
    "EnglishUK": ("EN-GB", None),

    "Spanish": ("ES", None),
    "SpanishLatin": ("LA-ES", "spa"),
    "Spanish (Latin America)": ("LA-ES", None),
    "Spanish (Mexico)": ("MX-ES", None),
    "SpanishMexico": ("MX-ES", None),
    "Castilian": ("ES", None),

    "Portuguese": ("PT", "por"),
    "Portuguese (Portugal)": ("PT-PT", None),
    "PortuguesePortugal": ("PT-PT", None),
    "Portuguese (Brazil)": ("PT-BR", None),
    "PortugueseBrazil": ("PT-BR", None),

    "French":  ("FR", "fra"),
    "French (Canada)": ("FR-CA", None),
    "FrenchCanada": ("FR-CA", None),
    ...
    "ModernStandardArabic": ("AR-001", None),
    "Arabic (Egypt)": ("AR-EG", None),
    "ArabicEgypt": ("AR-EG", None),
    ...
    "Cantonese": ("HK", None),
    "Chinese (Simplified)": ("ZH-CN", None),
    "SimplifiedChinese": ("ZH-CN", None),
