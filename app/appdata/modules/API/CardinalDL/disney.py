...
class DISNEY_CDL_API:
    def __init__(self) -> None:
        self.cdl_path = CDL_SERVICE_BIN_PATH
        self.cdl_working_dir = os.path.dirname(self.cdl_path)
        self.cdl_service = "disney"
        self.queue_service = "cdl-disney"
        self.service_config = config.cardinaldl.disney
        ...
        for json_index, season_data in enumerate(seasons_list):
            ...
            for episode_data in raw_episode_list:
                ...
                if raw_season_number not in (None, ""):
                    ...
                    if remote_specials.is_remote_special("cardinaldl", "disney", series_id, override_season_key, override_episode_number, episode_id=override_episode_id):
