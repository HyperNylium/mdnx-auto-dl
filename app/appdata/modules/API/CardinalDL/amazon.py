        ...
        for json_index, season_data in enumerate(seasons_list):
            ...
            for episode_data in raw_episode_list:
                ...
                if raw_season_number not in (None, ""):
                    ...
                    if remote_specials.is_remote_special("cardinaldl", "amazon", series_id, override_season_key, override_episode_number, episode_id=override_episode_id):
