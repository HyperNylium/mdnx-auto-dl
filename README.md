...
# What is this?
MDNX-auto-dl is a free and open-source Python application that monitors and downloads anime from Crunchyroll. It main usage is to monitor new anime that has weekly episode and download them to your plex/jellyfin/emby server.
This application only supports downloads anime from Crunchyroll at the moment even though multi-download-nx supports more services. This may change in the future.
